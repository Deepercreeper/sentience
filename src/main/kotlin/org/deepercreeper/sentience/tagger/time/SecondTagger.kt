...
class SecondTaggerConfig(symbolService: SymbolService) : SimpleTaggerConfig({ SecondTagger(it, symbolService) })

class SecondTagger(document: Document, symbolService: SymbolService) : AbstractValueTagger<Int>(document, KEY, symbolService) {
